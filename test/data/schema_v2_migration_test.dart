...
void main() {
  test('opens v1-shaped DB and migrates to v4 incorrect_count', () async {
...
''');
    ...
    // when from < 1 — we start at version 1 so only from < 2 / < 3 / < 4 runs.
    raw.dispose();
    ...
    expect(names.contains('incorrect_count'), isTrue);
  });
}
